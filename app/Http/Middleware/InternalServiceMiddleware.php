...
{
    /**
     * Handle de request para comunicación entre microservicios
     */
    public function handle(Request $request, Closure $next): Response
    {
        // token de servicio interno desde el header
        ...
        // a futuro se puede agregar verificación de IP/origen
        /*
    ...
    private function isValidInternalOrigin(Request $request): bool
    {
        ...
        $allowedRanges = [
            ...
            '190.14.159.0/24', // Server pruebas
        ];
